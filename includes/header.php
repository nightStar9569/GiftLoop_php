        ...
        <li class="user-menu" style="display: none">
          <a href="mypage.php" class="user-profile">
            <span class="nav-avatar" id="navAvatar"
              style="width:28px;height:28px;border-radius:50%;overflow:hidden;display:inline-flex;align-items:center;justify-content:center;background:#f3f4f6;margin-right:.5rem"><i
